...
export default function Map() {
	return (
		<div className="w-full h-auto gap-[30px] p-[30px] flex flex-col items-start justify-between bg-white">
			...
			<img className=" w-full h-[226px]" src="/Why invest_.svg" alt="Map" />
			<span className="w-full h-auto flex flex-row items-center justify-end">
				<span className="h-[52px] w-[136px] py-[17px] p-[10px] border-[1px] flex flex-row justify-between items-center  gap-[10px] border-[#4375FB] border-[1px]">
